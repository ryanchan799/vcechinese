...
export default function ThreadPage() {
  ...
  return (
    <div className={HEADER_BAR_WIDTHS.get(PAGE.FORUMS)}>
      ...
      >
        <div className="w-[680px] mx-16 my-[50px]">
          <div className="flex flex-row items-center pb-4 gap-3.5">
            {icon}
            <p className="text-[22px] tracking-[0.8px]">
          ...
          <div className="flex flex-row py-5 gap-2">
            ...
            <div className="text-[12px] space-y-4">
              <p>
                ...
                there are any problems.Hi all, apologies for the delay. After
                much back and forth with the Grok team, the marks for the
                Haskell portion of Assignment 2 are now available on Grok.
                Please let us know if there are any problems.Hi all, apologies
                for the delay. After much back and forth with the Grok team, the
                marks for the Haskell portion of Assignment 2 are now available
                on Grok. Please let us know if there are any problems.Hi all,
                apologies for the delay. After much back and forth with the Grok
                team, the marks for the Haskell portion of Assignment 2 are now
                available on Grok. Please let us know if there are any
                problems.Hi all, apologies for the delay. After much back and
                forth with the Grok team, the marks for the Haskell portion of
                Assignment 2 are now available on Grok. Please let us know if
                there are any problems.Hi all, apologies for the delay. After
