...
export default function ThreadPage() {
  return (
    <div className={HEADER_BAR_WIDTHS.get(PAGE.FORUMS)}>
      <div style={{ marginLeft: FORUMS_SIDEBAR_WIDTH }}>
        ...
        <div className="flex flex-row py-5 gap-2 font-light">
          ...
          <div className="text-[12px] space-y-4">
            <p>
              ...
              problems. Hi all, apologies for the delay. After much back and
              forth with the Grok team, the marks for the Haskell portion of
              Assignment 2 are now available on Grok. Please let us know if
              there are any problems.Hi all, apologies for the delay. After much
              back and forth with the Grok team, the marks for the Haskell
              portion of Assignment 2 are now available on Grok. Please let us
              know if there are any problems.Hi all, apologies for the delay.
              After much back and forth with the Grok team, the marks for the
              Haskell portion of Assignment 2 are now available on Grok. Please
              let us know if there are any problems.Hi all, apologies for the
              delay. After much back and forth with the Grok team, the marks for
              the Haskell portion of Assignment 2 are now available on Grok.
              Please let us know if there are any problems.Hi all, apologies for
              the delay. After much back and forth with the Grok team, the marks
              for the Haskell portion of Assignment 2 are now available on Grok.
              Please let us know if there are any problems.Hi all, apologies for
              the delay. After much back and forth with the Grok team, the marks
              for the Haskell portion of Assignment 2 are now available on Grok.
