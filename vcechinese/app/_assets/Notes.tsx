...
export const Lianhaoxiezuoyouduozhongyao: TextDisplay[] = [
  ...
  new TextDisplay(
    "plaintext",
    "作文是最容易得分，亦是最容易丢分的部分。一篇作文写得好不好，只需看一眼，就能知道。优秀的作文，往往会在用词、结构、内容、逻辑、语言等方面，做得很好，能让读者眼前一亮。而差的作文，则是有挑不完的毛病。作文，是笔试的重中之重，也是最能拉开分数差距的关键部分，大家一定要高度重视起来。接下来我们将对两个记叙文片段，展开深入的对比和分析。下面的两个片段，作文题目均是《我的十八岁生日》。"
  ),
